...
.Installed Operators in the `openshift-storage` namespace -- note the *IBM Storage Fusion Data Foundation* branding
image::odf-installed-operators.png[Installed Operators in openshift-storage]
...
.The StorageSystem view in the IBM Storage Fusion Data Foundation operator showing `ocs-storagecluster-storagesystem` in a healthy state
image::odf-storage-system.png[StorageSystem in IBM Storage Fusion Data Foundation]
