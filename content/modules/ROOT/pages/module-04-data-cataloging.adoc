...
+
image::lightspeed-policies.png[Lightspeed showing policy execution status via dcs_get_policies]
+
...
+
image::lightspeed-filetypes.png[Lightspeed showing file type breakdown via dcs_file_search]
+
...
+
image::lightspeed-storage.png[Lightspeed showing storage consumption by file type]
+
