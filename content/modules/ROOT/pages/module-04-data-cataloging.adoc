...
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
echo "Connect to DCS using username sdadmin password ${DCS_PW} and cluster URL https://api.ocp.{cluster_domain}:6443"
----

Copy the output message and paste it into the Lightspeed chat panel. Lightspeed will call the `dcs_set_credentials` MCP tool automatically. You should see a confirmation: *"Token generated successfully for sdadmin"*.
