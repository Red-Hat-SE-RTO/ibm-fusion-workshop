...
. Verify which files were tagged by the policy:
+
* "Show me all PDF files and their DOC_CATEGORY tag value"
+
You should see all 3 PDFs tagged with `reference-guide`.
+
. Assess classification coverage:
+
* "How many files in the catalog have a DOC_CATEGORY tag set versus those that don't? Give me a count of classified vs unclassified."
+
